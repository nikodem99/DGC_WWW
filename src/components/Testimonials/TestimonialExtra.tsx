...
interface TestimonialExtraProps {
...
export default function TestimonialExtra({ testimonial }: TestimonialExtraProps) {
  return (
    <div className="sc_testimonials_item sc_testimonials_item_extra">
