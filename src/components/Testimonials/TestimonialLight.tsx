...
interface TestimonialLightProps {
  testimonial: Testimonial;
}

export default function TestimonialLight({ testimonial }: TestimonialLightProps) {
  return (
    <div className="sc_testimonials_item sc_testimonials_item_light">
