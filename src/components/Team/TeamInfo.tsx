...
export default function TeamInfo({ member }: TeamInfoProps) {
  return (
    <div className="sc_team_item sc_team_item_info">
      ...
      <div className="sc_team_item_info_wrap">
          ...
          <div className="sc_team_item_socials">
            {member.socials.map((social) => (
              <a
                key={social.name}
                href={social.url}
                className="social_item social_item_colored"
                target="_blank"
