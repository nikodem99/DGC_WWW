...
export default function TeamModern({ member }: TeamModernProps) {
  return (
    <div className="sc_team_item sc_team_item_modern">
      <div className="sc_team_item_avatar">
        ...
        <div className="sc_team_item_overlay">
          <div className="sc_team_item_overlay_content">
