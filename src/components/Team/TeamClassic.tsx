...
export default function TeamClassic({ member }: TeamClassicProps) {
  return (
    <div className="sc_team_item sc_team_item_classic">
          ...
          <div className="sc_team_item_socials">
            {member.socials.map((social) => (
              <a
                key={social.name}
                href={social.url}
                className="social_item social_item_text"
                target="_blank"
